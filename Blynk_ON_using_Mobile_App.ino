//Controlling Blynk app from Input from a Switch
...
char auth[] = "Your Token Here";                       		  //Auth Token will be get from blynk

char ssid[] = "WIFI SSID here";                                         //Assespoint name
char pass[] = "Wifi Password here";                                     //Password
